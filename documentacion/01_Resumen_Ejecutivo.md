# TFM: BiblioMobil - Gestión Inteligente de Bibliotecas Personales

## 1. Introducción
BiblioMobil es una solución móvil avanzada diseñada para la catalogación y gestión de colecciones de libros y cómics. El proyecto nace de la necesidad de digitalizar bibliotecas físicas de manera rápida y eficiente, aprovechando las últimas tecnologías de visión artificial e inteligencia artificial generativa.

## 2. Objetivos del Proyecto
- **Automatización**: Reducir el tiempo de entrada de datos mediante el escaneo de códigos ISBN.
