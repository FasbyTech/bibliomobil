# BiblioMobil - Documentación TFM

Este directorio contiene el conjunto completo de documentos técnicos y funcionales que componen la memoria del Trabajo de Fin de Máster (TFM) para el proyecto **BiblioMobil**.
...
17. **[17_Codigo_Fuente_Completo.md](./17_Codigo_Fuente_Completo.md)**: Documento exhaustivo con todas las clases del proyecto.

---

### Instrucciones para la Entrega en PDF:
Cada documento ha sido redactado en **Markdown Profesional**. Para generar los archivos PDF finales:
1. Abra cada archivo en Android Studio.
2. Use la función **File > Print...** o exporte directamente si dispone de extensiones de Markdown.
3. Se recomienda el uso de un estilo con fuentes monoespaciadas para los bloques de código (08_Codigo_Fuente) para garantizar la legibilidad.
